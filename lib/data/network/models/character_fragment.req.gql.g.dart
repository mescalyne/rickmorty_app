...
part of 'character_fragment.req.gql.dart';
...
class _$GCharacterFragmentReq extends GCharacterFragmentReq {
  ...
  factory _$GCharacterFragmentReq(
      ...
      (new GCharacterFragmentReqBuilder()..update(updates)).build();
  ...
  _$GCharacterFragmentReq._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        vars, 'GCharacterFragmentReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        document, 'GCharacterFragmentReq', 'document');
    BuiltValueNullFieldError.checkNotNull(
        idFields, 'GCharacterFragmentReq', 'idFields');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GCharacterFragmentReq')
          ..add('vars', vars)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GCharacterFragmentReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
